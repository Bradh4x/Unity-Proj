...
public class GoldenSkull_CustomHandleEditor : Editor
{
    ...
    private void newHandle()
    {
        ...
        obj.groundPos = Handles.FreeMoveHandle(obj.groundPos+ freemoveHandleOffset, Quaternion.Euler(obj.rotation), obj.handleUIScale*0.1f, Vector3.one, Handles.DotHandleCap)- freemoveHandleOffset;
